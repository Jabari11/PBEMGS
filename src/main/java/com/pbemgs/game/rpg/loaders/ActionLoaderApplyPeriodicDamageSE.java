...
import com.pbemgs.game.rpg.combat.action.ActionApplyPeriodicDamageSE;
...
public class ActionLoaderApplyPeriodicDamageSE {

    public static Map<String, Action> loadPeriodicDamageSEActions(String csvFilePath, CombatLog combatLog) {
        Map<String, Action> actions = new HashMap<>();
        String[] expectedHeaders = {
                "ActionApplyPeriodicDamageSE", "targetType", "isFriendly", "splashCount", "chanceToHit",
                "seName", "classification", "duration", "baseAmount", "damageTypes",
                "piercePct", "crushPct", "condition"
        };
        ...
        try (CSVReader reader = new CSVReader(new FileReader(csvFilePath), ',', '"', 0)) {
            ...
            while ((row = reader.readNext()) != null) {
                ...
                try {
                    ...
                    String name = parseString(rowData, "ActionApplyPeriodicDamageSE", rowNum, true);
                    ...
                    float baseAmount = parseSignedFloat(rowData, "baseAmount", rowNum);
                    ...
                    Action action = new ActionApplyPeriodicDamageSE(
                            name, targetType, isFriendly, splashCount, chanceToHit, seName, classification,
                            duration, baseAmount, damageTypes, piercePct, crushPct, condition
                    );
